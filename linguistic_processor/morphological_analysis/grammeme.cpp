...
std::map<boost::string_view, Grammeme> BuildIndex() {
    std::map<boost::string_view, Grammeme> result;
...
const std::map<boost::string_view, Grammeme> INDEX_BY_NAME = BuildIndex();
